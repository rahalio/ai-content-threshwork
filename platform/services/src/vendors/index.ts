/**
 * Vendors Services - Application Layer Export
 *
...
/**
 * Vendors Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for vendors domain.
 */
