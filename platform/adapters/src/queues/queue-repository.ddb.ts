/**
 * QueueRepository - DynamoDB Implementation
 *
 ...
 * QueueRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Queue repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { QueueRepository } from "@ddd/services/queues";
...
/**
 * QueueRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: QUEUE
 * Entity Token: QUEUE
 * SK Prefix: QUEUE
 */
export class QueueRepositoryDdb implements QueueRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "QUEUE";
  private readonly ENTITY_TOKEN = "QUEUE";
  private readonly SK_PREFIX = "QUEUE";
  ...
  private readonly ENTITY_TYPE_PK = "QUEUES";
