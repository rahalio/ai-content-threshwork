/**
 * GoldenSetRepository - DynamoDB Implementation
 *
...
/**
 * GoldenSetRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing GoldenSet repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { GoldenSetRepository } from "@ddd/services/vendors";
...
/**
 * GoldenSetRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: GOLDEN_SET
 * Entity Token: GOLDEN_SET
 * SK Prefix: GOLDEN_SET
 */
export class GoldenSetRepositoryDdb implements GoldenSetRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "GOLDEN_SET";
  private readonly ENTITY_TOKEN = "GOLDEN_SET";
  private readonly SK_PREFIX = "GOLDEN_SET";
  ...
  private readonly ENTITY_TYPE_PK = "GOLDEN_SETS";
