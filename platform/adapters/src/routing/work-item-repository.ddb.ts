/**
 * WorkItemRepository - DynamoDB Implementation
 *
...
/**
 * WorkItemRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing WorkItem repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { WorkItemRepository } from "@ddd/services/routing";
...
/**
 * WorkItemRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: WORK_ITEM
 * Entity Token: WORK_ITEM
 * SK Prefix: WORK_ITEM
 */
export class WorkItemRepositoryDdb implements WorkItemRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "WORK_ITEM";
  private readonly ENTITY_TOKEN = "WORK_ITEM";
  private readonly SK_PREFIX = "WORK_ITEM";
  ...
  private readonly ENTITY_TYPE_PK = "WORK_ITEMS";
