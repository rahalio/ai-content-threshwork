/**
 * ResponseClockRepository - DynamoDB Implementation
 *
...
/**
 * ResponseClockRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing ResponseClock repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { ResponseClockRepository } from "@ddd/services/routing";
...
/**
 * ResponseClockRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: RESPONSE_CLOCK
 * Entity Token: RESPONSE_CLOCK
 * SK Prefix: RESPONSE_CLOCK
 */
export class ResponseClockRepositoryDdb implements ResponseClockRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "RESPONSE_CLOCK";
  private readonly ENTITY_TOKEN = "RESPONSE_CLOCK";
  private readonly SK_PREFIX = "RESPONSE_CLOCK";
  ...
  private readonly ENTITY_TYPE_PK = "RESPONSE_CLOCKS";
  ...
  async listResponseClocks(input: Parameters<ResponseClockRepository['listResponseClocks']>[0]): Promise<Awaited<ReturnType<ResponseClockRepository['listResponseClocks']>>> {
