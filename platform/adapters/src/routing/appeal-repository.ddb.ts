/**
 * AppealRepository - DynamoDB Implementation
 *
 ...
 * AppealRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Appeal repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { AppealRepository } from "@ddd/services/routing";
...
/**
 * AppealRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: APPEAL
 * Entity Token: APPEAL
 * SK Prefix: APPEAL
...
export class AppealRepositoryDdb implements AppealRepository {
  ...
  private readonly ENTITY_TYPE = "APPEAL";
  private readonly ENTITY_TOKEN = "APPEAL";
  private readonly SK_PREFIX = "APPEAL";
  ...
  private readonly ENTITY_TYPE_PK = "APPEALS";
