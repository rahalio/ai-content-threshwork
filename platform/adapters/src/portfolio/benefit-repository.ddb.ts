/**
 * BenefitRepository - DynamoDB Implementation
 *
...
/**
 * BenefitRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Benefit repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { BenefitRepository } from "@ddd/services/portfolio";
...
/**
 * BenefitRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: BENEFIT_RECORD
 * Entity Token: BENEFIT_RECORD
 * SK Prefix: BENEFIT_RECORD
 */
export class BenefitRepositoryDdb implements BenefitRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "BENEFIT_RECORD";
  private readonly ENTITY_TOKEN = "BENEFIT_RECORD";
  private readonly SK_PREFIX = "BENEFIT_RECORD";
  ...
  private readonly DOMAIN = "PORTFOLIO";
  private readonly ENTITY_TYPE_PK = "BENEFIT_RECORDS";
  private generateCorrelationId(): string {
    const domainPrefix = "pfl";
