/**
 * EgressRecordRepository - DynamoDB Implementation
 *
...
/**
 * EgressRecordRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing EgressRecord repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { EgressRecordRepository } from "@ddd/services/portfolio";
...
/**
 * EgressRecordRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: EGRESS_RECORD
 * Entity Token: EGRESS_RECORD
 * SK Prefix: EGRESS_RECORD
 */
export class EgressRecordRepositoryDdb implements EgressRecordRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "EGRESS_RECORD";
  private readonly ENTITY_TOKEN = "EGRESS_RECORD";
  private readonly SK_PREFIX = "EGRESS_RECORD";
  ...
  private readonly ENTITY_TYPE_PK = "EGRESS_RECORDS";
