/**
 * RoadmapRepository - DynamoDB Implementation
 *
...
/**
 * RoadmapRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Roadmap repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { RoadmapRepository } from "@ddd/services/portfolio";
...
/**
 * RoadmapRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: ROADMAP_ENTRY
 * Entity Token: ROADMAP_ENTRY
 * SK Prefix: ROADMAP_ENTRY
 */
export class RoadmapRepositoryDdb implements RoadmapRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "ROADMAP_ENTRY";
  private readonly ENTITY_TOKEN = "ROADMAP_ENTRY";
  private readonly SK_PREFIX = "ROADMAP_ENTRY";
  ...
  private readonly ENTITY_TYPE_PK = "ROADMAP_ENTRYS";
